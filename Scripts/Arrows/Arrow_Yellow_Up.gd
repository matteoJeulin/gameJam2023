...
func _ready() :
	get_node("../Switch_Arrow_Yellow_Antitrigo").connect("switch_" + type.color + "_antitrigo", switch_antitrigo)
	get_node("../Switch_Arrow_Yellow_Trigo").connect("switch_" + type.color + "_trigo", switch_trigo)
